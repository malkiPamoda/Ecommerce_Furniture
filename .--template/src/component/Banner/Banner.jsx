  ...
  return (
    <div className='min-h-[550px] flex justify-center items-center py-12 sm:py-0'>
        <div className='container'>
            ...
            gap-6 sm:pt-0'>
                <h1 data-aos="fade-up" className='text-3xl sm:text-4xl font-bold'>Year end sale upto 50% off</h1>
                <p data-aos="fade-up" aosDelay="100"className='text-sm: text-gray-500 tracking-wide leading-5'>
                Revamp your home with our incredible furniture sale! Enjoy up to 50% off on selected items during our exclusive year-end sale. Don't miss out on the chance to elevate your space for less!
                </p>
